...
${OBJECTDIR}/_ext/1472/Led.o: ../Led.asm  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} dummy.d -e "${OBJECTDIR}/_ext/1472/Led.err" $(SILENT) -c ${MP_AS} $(MP_EXTRA_AS_PRE) -d__DEBUG  -q -p$(MP_PROCESSOR_OPTION) -u  -l\"${OBJECTDIR}/_ext/1472/Led.lst\" -e\"${OBJECTDIR}/_ext/1472/Led.err\" $(ASM_OPTIONS)  -o\"${OBJECTDIR}/_ext/1472/Led.o\" ../Led.asm 
...
${OBJECTDIR}/_ext/1472/Delay.o: ../Delay.asm  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} dummy.d -e "${OBJECTDIR}/_ext/1472/Delay.err" $(SILENT) -c ${MP_AS} $(MP_EXTRA_AS_PRE) -d__DEBUG  -q -p$(MP_PROCESSOR_OPTION) -u  -l\"${OBJECTDIR}/_ext/1472/Delay.lst\" -e\"${OBJECTDIR}/_ext/1472/Delay.err\" $(ASM_OPTIONS)  -o\"${OBJECTDIR}/_ext/1472/Delay.o\" ../Delay.asm 
...
${OBJECTDIR}/_ext/1472/SampleDelayedSingle.o: ../SampleDelayedSingle.asm  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} dummy.d -e "${OBJECTDIR}/_ext/1472/SampleDelayedSingle.err" $(SILENT) -c ${MP_AS} $(MP_EXTRA_AS_PRE) -d__DEBUG  -q -p$(MP_PROCESSOR_OPTION) -u  -l\"${OBJECTDIR}/_ext/1472/SampleDelayedSingle.lst\" -e\"${OBJECTDIR}/_ext/1472/SampleDelayedSingle.err\" $(ASM_OPTIONS)  -o\"${OBJECTDIR}/_ext/1472/SampleDelayedSingle.o\" ../SampleDelayedSingle.asm 
...
${OBJECTDIR}/_ext/1472/SampleFastestSingle.o: ../SampleFastestSingle.asm  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} dummy.d -e "${OBJECTDIR}/_ext/1472/SampleFastestSingle.err" $(SILENT) -c ${MP_AS} $(MP_EXTRA_AS_PRE) -d__DEBUG  -q -p$(MP_PROCESSOR_OPTION) -u  -l\"${OBJECTDIR}/_ext/1472/SampleFastestSingle.lst\" -e\"${OBJECTDIR}/_ext/1472/SampleFastestSingle.err\" $(ASM_OPTIONS)  -o\"${OBJECTDIR}/_ext/1472/SampleFastestSingle.o\" ../SampleFastestSingle.asm 
...
${OBJECTDIR}/_ext/713068069/usb_device.o: ../../Microchip/USB/usb_device.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG  -p$(MP_PROCESSOR_OPTION) -I".." -I"../../Microchip/Include"  -I ${MP_CC_DIR}/../h  -fo ${OBJECTDIR}/_ext/713068069/usb_device.o   ../../Microchip/USB/usb_device.c 
...
${OBJECTDIR}/_ext/1702484533/usb_function_hid.o: ../../Microchip/USB/HID\ Device\ Driver/usb_function_hid.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG  -p$(MP_PROCESSOR_OPTION) -I".." -I"../../Microchip/Include"  -I ${MP_CC_DIR}/../h  -fo ${OBJECTDIR}/_ext/1702484533/usb_function_hid.o   "../../Microchip/USB/HID Device Driver/usb_function_hid.c" 
	@${DEP_GEN} -d ${OBJECTDIR}/_ext/1702484533/usb_function_hid.o 
	
${OBJECTDIR}/_ext/1472/main.o: ../main.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/1472 
	@${RM} ${OBJECTDIR}/_ext/1472/main.o.d 
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG  -p$(MP_PROCESSOR_OPTION) -I".." -I"../../Microchip/Include"  -I ${MP_CC_DIR}/../h  -fo ${OBJECTDIR}/_ext/1472/main.o   ../main.c 
	@${DEP_GEN} -d ${OBJECTDIR}/_ext/1472/main.o 
	
${OBJECTDIR}/_ext/1472/usb_descriptors.o: ../usb_descriptors.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/1472 
	@${RM} ${OBJECTDIR}/_ext/1472/usb_descriptors.o.d 
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG  -p$(MP_PROCESSOR_OPTION) -I".." -I"../../Microchip/Include"  -I ${MP_CC_DIR}/../h  -fo ${OBJECTDIR}/_ext/1472/usb_descriptors.o   ../usb_descriptors.c 
...
${OBJECTDIR}/_ext/1472/ISR.o: ../ISR.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG  -p$(MP_PROCESSOR_OPTION) -I".." -I"../../Microchip/Include"  -I ${MP_CC_DIR}/../h  -fo ${OBJECTDIR}/_ext/1472/ISR.o   ../ISR.c 
...
dist/${CND_CONF}/${IMAGE_TYPE}/MPLAB.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_LD} $(MP_EXTRA_LD_PRE)   -p$(MP_PROCESSOR_OPTION_LD)  -w -x -u_DEBUG -m"osci.map" -i  -z__MPLAB_BUILD=1  -u_CRUNTIME -z__MPLAB_DEBUG=1 $(MP_LINKER_DEBUG_OPTION) -l ${MP_CC_DIR}/../lib  -o dist/${CND_CONF}/${IMAGE_TYPE}/MPLAB.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}    -i
else
dist/${CND_CONF}/${IMAGE_TYPE}/MPLAB.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
